...
"""
function _config_key_value(key_name::Symbol, config_path=string(Pkg.dir(), "/JAXTAM/user_configs.jld"))
    config_data = _config_load(config_path)
...
"""
function config(key_name::Symbol, key_value::Union{String,Symbol,MissionDefinition})
